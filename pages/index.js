...
// Estilos inline para grad1 e grad2
    const grad1Style = {
        background: 'linear-gradient(to right, orange, yellow, green, cyan, blue, violet)',  // Gradiente
...
function Home()
{
    ...
    <h1 style={grad2Style}>Você foi pego, não é a Mikasa, apenas A máquina Erwin Smith 😎</h1>
